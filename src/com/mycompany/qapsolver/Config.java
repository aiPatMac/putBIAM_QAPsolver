...
public class Config {
    ...
    public static final int RUNS_PER_INSTANCE = 3;    // number of runs per instance
    public static final int MAX_INSTANCES = 1;          // maximum number of working instances to process
